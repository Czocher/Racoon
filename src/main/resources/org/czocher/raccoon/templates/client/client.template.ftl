...
<@m.template>
	<h1>Client #${client.id} <a class="operation" href="/${clientDeletePath}?id=${client.id}"><span class="glyphicon glyphicon-trash"></span> </a><a class="operation" href="/${clientEditPath}?id=${client.id}"><span class="glyphicon glyphicon-pencil"></span> </a></h1>
	<ul>
